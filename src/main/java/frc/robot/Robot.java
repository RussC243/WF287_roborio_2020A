...
public class Robot extends TimedRobot {
  ...
  public void linkJoyStickToDrive()
  {
    ...
    if(joy.getRawButton(hMap.button_testA))
    {
      System.out.println("hello button A");//print to driver station console
    }
    if(joy.getRawButton(hMap.buttonB_testB))
    {
      System.out.println("hello button B");
    }
  }
}
